...
| `s2e` | [S2E](https://github.com/VAIL-UCLA/S2E) | BC Web100 variant; eleven RGB frames, 256×256, point-goal | `s2e` follows the paper's EfficientNet-B0 encoder and 8-anchor mixture head; no RL stage |
